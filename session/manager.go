...
func (m *Manager) GetSession(ctx *toyweb.Context) (Session, error) {
...
func (m *Manager) InitSession(ctx *toyweb.Context, id string) (Session, error) {
...
func (m *Manager) RefreshSession(ctx *toyweb.Context) (Session, error) {
...
func (m *Manager) RemoveSession(ctx *toyweb.Context) error {
	sess, err := m.GetSession(ctx)
	if err != nil {
		return err
	}
